(function (data) {
  ...
  st.initRoot = function () {
    ...
    jQuery('.banner-anim-block').append(st.scene)
  ...
  st.filterElement = function (g, filters) {
    ...
    this.Fo = function (x, y, result) {
      ...
      if (result !== false) { fo.setAttribute('result', result) }
    ...
    this.Com = function (operator, in1, in2, k2, k3, result) {
      ...
      if (in1 !== false) { composite.setAttribute('in', in1) }
      if (in2 !== false) { composite.setAttribute('in2', in2) }

      composite.setAttribute('operator', operator)
      if (k2 != 0) { composite.setAttribute('k2', k2) }
      if (k3 != 0) { composite.setAttribute('k3', k3) }
